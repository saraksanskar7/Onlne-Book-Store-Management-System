        ...
        <form action="" method="POST">
          ...
          <div class="row">
            <div class="col-50">
              ...
              <input type="text" id="fname" name="firstname" placeholder="Sarak Sanskar">
              <label for="email"><i class="fa fa-envelope"></i> Email</label>
              <input type="text" id="email" name="email" placeholder="sanskarsarak@gmail.com">
              <label for="email"><i class="fa fa-envelope"></i> Number</label>
              <input type="text" id="email" name="number" placeholder="+91 7447755732">
              <label for="adr"><i class="fa fa-address-card-o"></i> Address</label>
              <input type="text" id="adr" name="address" placeholder="Solapur 413310">
              <label for="city"><i class="fa fa-institution"></i> City</label>
              <input type="text" id="city" name="city" placeholder="Chandapuri">
              ...
              <div style="padding: 0px;" class="row">
                ...
                <div class="col-50">
                  ...
                  <input type="text" id="zip" name="pincode" placeholder="413310">
                </div>
              </div>
            </div>
