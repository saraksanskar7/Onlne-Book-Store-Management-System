...
$admin_no = mysqli_query($conn, "SELECT * FROM users_info WHERE user_type='Admin'") or die('query failed');
$admin_count = mysqli_num_rows($admin_no);

$books_no = mysqli_query($conn, "SELECT * FROM book_info") or die('query failed');
...
$msg_no = mysqli_query($conn, "SELECT * FROM msg") or die('query failed');
